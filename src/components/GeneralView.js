...
const categories = [
    {   id: 1,
        image: '/images/history.jpg',        //card img
        category: 'History',                 //card title
        description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua'   //card details
    },
    {
        id: 2,
...
class GeneralView extends Component {
    ...
    changeCategory = fromChild => {
        // console.log(fromChild)
        this.setState({
            movies : movieCategoryTop5[fromChild],
            display: !this.state.display , //it toggles the button
                ...
                <CardGroup>
                    {
                        categories.map( item=>
                            <Category
                                ...
                                sendCategory={this.changeCategory}
                            />
                                      )
                    }
                </CardGroup>

                <Movie movieList = {this.state.movies} tableToggle = { this.state.display }  />
